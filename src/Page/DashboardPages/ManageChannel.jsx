...
function ManageChannel() {
  ...
  const fetchChannels = async () => {
    try {
      const response = await fetch('https://fly-book-server-lzu4.onrender.com/api/channels/admin');
  ...
  const updateChannelStatus = async (channelId, newStatus) => {
    try {
      const response = await fetch(`https://fly-book-server-lzu4.onrender.com/api/channels/${channelId}/status`, {
        method: 'PATCH',
        headers: {
