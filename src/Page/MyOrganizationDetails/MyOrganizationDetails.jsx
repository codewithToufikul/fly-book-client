...
const MyOrganizationDetails = () => {
    ...
    useEffect(() => {
        const fetchOrganizationDetails = async () => {
            try {
                const response = await publicAxios.get(`/api/v1/organizations/${orgId}`);
    ...
    const handleDeleteSection = async (sectionIndex) => {
        ...
        if (result.isConfirmed) {
            setLoading(true);
            try {
                await publicAxios.delete(`/organizations/${orgId}/sections/${sectionIndex}`);
    ...
    const handleEditSection = async (e) => {
        ...
        try {
            ...
            await publicAxios.put(`/organizations/${orgId}/sections/${editingSection.index}`, sectionData);
            ...
            <div className="max-w-4xl mx-auto space-y-8 px-4 sm:px-6">
                ...
                {isEditingSectionOpen && editingSection && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 overflow-y-auto">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <input
                                                type="file"
                                                accept="image/*"
                                                onChange={(e) => setEditingSection({ ...editingSection, newImage: e.target.files[0] })}
                                                className="hidden"
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <input
                                                type="file"
                                                accept="video/*"
                                                onChange={(e) => setEditingSection({ ...editingSection, newVideo: e.target.files[0] })}
                                                className="hidden"
                                    ...
                                    if (file) {
                                        ...
                                        try {
                                            ...
                                            if (imageUrl) {
                                                ...
                                                setOrganization(prev => ({ ...prev, profilePicture: imageUrl }));
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-800 mb-4">{organization?.orgName}</h1>
                ...
                <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
                    {sections.map((section, index) => (
                        <div key={index} className="bg-white rounded-xl shadow-lg p-6 space-y-4 relative">
                            ...
                            <p className="text-gray-600 whitespace-pre-wrap">{section.details}</p>
                            ...
                            <form onSubmit={handleAddSection} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) => setNewSection({ ...newSection, details: e.target.value })}
                                        className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none min-h-[150px]"
                                        required
                                    />
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <input
                                                type="file"
                                                accept="image/*"
                                                onChange={(e) => setNewSection({ ...newSection, image: e.target.files[0] })}
                                                className="hidden"
                                                id="image-upload"
                                            />
                                            <label
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <input
                                                type="file"
                                                accept="video/*"
                                                onChange={(e) => setNewSection({ ...newSection, video: e.target.files[0] })}
                                                className="hidden"
                                                id="video-upload"
                                            />
                                            <label
